...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  24.6907
    #define DEFAULT_Ki   2.1246
    #define DEFAULT_Kd  71.7356
    //Set via Autotune 4/30/2021 PBM
  #endif
#endif // PIDTEMP
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 690 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define DUET_SMART_EFFECTOR
  ...
  #define SMART_EFFECTOR_MOD_PIN  P1_00  // Connect a GPIO pin to the Smart Effector MOD pin
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0.0, 0.0, 0.15 }
